 ...
 * Use the {@link fragmento_b#newInstance} factory method to
...
public class fragmento_b extends Fragment {
    ...
    public static fragmento_b newInstance(String param1, String param2) {
        fragmento_b fragment = new fragmento_b();
