 ...
 * Use the {@link fragmento_a#newInstance} factory method to
...
public class fragmento_a extends Fragment {
    ...
    public static fragmento_a newInstance(String param1, String param2) {
        fragmento_a fragment = new fragmento_a();
